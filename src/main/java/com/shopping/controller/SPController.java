...
public class SPController {
    ...
    SPMapper spMapper;
    //查询单个种类商品
    @RequestMapping("search/{currentPage}/{ptypeid}/{pdescription}.action")
    public ModelAndView searchPage(@PathVariable(name="currentPage") Integer currentPage,
            @PathVariable(name="ptypeid",required = false) Integer ptypeid,
            @PathVariable(name="pdescription",required = false) String pdescription){
