...
(function($) {
    ...
    var methods = {
        ...
        init : function(options, swfUploadOptions) {
            ...
            return this.each(function() {
                ...
                // var flashInstalled = (playerVersion.major >= 9);//鍘熸湰
                var flashInstalled = (playerVersion.major >= 9 || playerVersion.major == 0);//鏇存敼锛�0鐘舵€佷负鏂扮増璋锋瓕娴忚鍣ㄤ笉榛樿寮€鍚痜lash
    ...
    var handlers = {
        ...
        onDialogOpen : function() {
            ...
            this.queueData.errorMsg       = '鍥剧墖涓婁紶閿欒:';
            ...
            if ($.inArray('onSelectError', settings.overrideEvents) < 0) {
                switch(errorCode) {
                    ...
                    case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
                        this.queueData.errorMsg += '\n\n鍥剧墖鏂囦欢(' + file.name + ')瓒呭嚭1M锛岃閲嶆柊閫夋嫨.';
                        break;
