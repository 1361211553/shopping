                ...
                <div class="mod mod-basic account-num" id="account_num">
                    ...
                    <table>
                        ...
                        <c:forEach var="address" items="${addresslist}">
                            <tr>
                                <td align="left">${address.consignee}</td>
                                <td align="left">${address.city}${address.dist}${address.detailed}</td>
                                ...
                                <c:if test="${address.status == 1}">
                                    <td align="left"><font color="red">* 默认地址</font></td>
                                </c:if>
                                <c:if test="${address.status == 0}">
                                    <td align="left"></td>
                                </c:if>
                        ...
                        <c:if test="${addresslist eq null}">
                            <tr>
                                <td colspan="5">您还没有购买任何商品哦，快去<a href="products.jsp" style="font-size: 20px"><font
                                        color="red">购买</font></a>吧！
                                </td>
                            </tr>
                        </c:if>
                        <%--</c:if>--%>
