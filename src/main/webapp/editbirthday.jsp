            ...
            <div class="mod">
                ...
                <div class="mod-hd has-bind-phone">
                    ...
                    <div class="has-bind-title">
                        <p>我的生日：<span id="oldNick">${user.userbirthday}</span></p>

                    </div>

                    <!-- 填写内容 -->
                    <form id="editbirthday"  method="post" action="/user/update">
                        <div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">

                            <input type="hidden" name="userid" value="${user.userid}" >

                            <input id="" style="height: 40px" type="text" class="Wdate" name="userbirthday" placeholder="请选择您的生日" onfocus="WdatePicker({readOnly:true,maxDate:'%y-%M-%d'})" />

                            <input type="button" style="width: 255px;height: 40px" id="setbirthday" value="确认">
